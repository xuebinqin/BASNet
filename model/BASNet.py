...
class RefOutConv(nn.Module):
    def __init__(self,in_ch,inc_ch):
        super(RefOutConv, self).__init__()

        self.conv1_1 = nn.Conv2d(in_ch,inc_ch,3,padding=1)
    ...
    def forward(self,x):
        ...
        hxout = hx1#self.conv2_1(torch.cat((hx0,hx1,hx2),1))
...
class myResUNetSOTE106(nn.Module):
    def __init__(self, n_channels, n_classes):
        super(myResUNetSOTE106, self).__init__()
        ...
        self.outconvb = RefOutConv(512,1)# nn.Conv2d(512,1,3,padding=1)
        self.outconv6 = RefOutConv(512,1)# nn.Conv2d(512,1,3,padding=1)
        self.outconv5 = RefOutConv(512,1)# nn.Conv2d(512,1,3,padding=1)
        self.outconv4 = RefOutConv(256,1)# nn.Conv2d(256,1,3,padding=1)
        self.outconv3 = RefOutConv(128,1)# nn.Conv2d(128,1,3,padding=1)
        self.outconv2 = RefOutConv(64,1)# nn.Conv2d(64,1,3,padding=1)
        self.outconv1 = RefOutConv(64,1)# nn.Conv2d(64,1,3,padding=1)

        # self.ref_convdb_1 = RefConvInt25N(1,64)###
        # self.ref_convdb_2 = RefConvInt25N(1,64)###
        #
        # self.ref_convd6_1 = RefConvInt25N(1,64)###
        # self.ref_convd6_2 = RefConvInt25N(1,64)###
        #
        # self.ref_convd5_1 = RefConvInt25N(1,64)
        # self.ref_convd5_2 = RefConvInt25N(1,64)
        #
        # self.ref_convd4_1 = RefConvInt25N(1,64)
        # self.ref_convd4_2 = RefConvInt25N(1,64)
        #
        # self.ref_convd3_1 = RefConvInt25N(1,64)
        # self.ref_convd3_2 = RefConvInt25N(1,64)
        #
        # self.ref_convd2_1 = RefConvInt25N(1,64)
        # self.ref_convd2_2 = RefConvInt25N(1,64)

        # self.ref_convd1_1 = RefConvInt25M(1,64)
        # self.ref_convd1_2 = RefConvInt25M(1,64)
        #
        # self.ref_conv0_1 = RefConv(1,64) ### resunet11
        # self.ref_conv0_2 = RefConv(1,64) ### resunet11
    ...
    def forward(self,x):
        ...
        hx = self.resb5_1(hx)
        hx = self.resb5_2(hx)
        h5 = self.resb5_3(hx) # 14

        hx = self.pool5(h5)

        hx = self.resb6_1(hx)
        hx = self.resb6_2(hx)
        h6 = self.resb6_3(hx) # 7

        ################
        ### Bridge ####
        ################
        hx = self.relubg_1(self.bnbg_1(self.convbg_1(h6))) # 1/64
        hx = self.relubg_m(self.bnbg_m(self.convbg_m(hx)))
        hbg = self.relubg_2(self.bnbg_2(self.convbg_2(hx)))
        ...
        db = self.outconvb(hbg)###
        # db = self.ref_convdb_1(db)###
        # db = self.ref_convdb_2(db)###

        d6 = self.outconv6(hd6)###
        # d6 = self.ref_convd6_1(d6)###
        # d6 = self.ref_convd6_2(d6)###

        d5 = self.outconv5(hd5)
        # d5 = self.ref_convd5_1(d5)
        # d5 = self.ref_convd5_2(d5)

        d4 = self.outconv4(hd4)
        # d4 = self.ref_convd4_1(d4)
        # d4 = self.ref_convd4_2(d4)

        d3 = self.outconv3(hd3)
        # d3 = self.ref_convd3_1(d3)
        # d3 = self.ref_convd3_2(d3)

        d2 = self.outconv2(hd2)
        # d2 = self.ref_convd2_1(d2)
        # d2 = self.ref_convd2_2(d2)

        d1 = self.outconv1(hd1)
        # d1 = self.ref_convd1_1(d1)
        # d1 = self.ref_convd1_2(d1)
        #
        # d1 = self.ref_conv0_1(d1)
        # d1 = self.ref_conv0_2(d1)
